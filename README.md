...
16進キーボードを使ったことはあるけど、トグルスイッチを使ってプログラムを動かしてみたいという方の願いを叶えようという思いで作られたシンプルなボードです。モニタプログラムなどの助けを借りずに、トグルスイッチでのメモリを直接書き換えて実行することを体験することで、CPUとハードウェアの仕組みに極限まで近づくことができます。  
